...
import useSupportAuthClient from 'hooks/useSupportAuthClients';
...
export default function Application() {
  ...
  const supportAuthClients = useSupportAuthClient();
  ...
  console.log(`supportAuthClients = ${supportAuthClients}`);
